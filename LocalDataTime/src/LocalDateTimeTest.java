 ...
 */
    ...
    static LocalDateTime localDateTimeOf() {
         ...
         */
        LocalDateTime ldt=LocalDateTime.of(2015, 6,20,23,07,30);
        return ldt;
    }
    static LocalDateTime localDateTimeParse() {
         ...
         */
        LocalDateTime ldt=LocalDateTime.parse("2015-06-20T23:07:30");
        return ldt;
    }
    static LocalDateTime localTimeWith() {
         ...
         */
        return ldt.plusMonths(1).withDayOfMonth(1).truncatedTo(ChronoUnit.HOURS);
    }
